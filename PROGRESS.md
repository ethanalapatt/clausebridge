...
| D | Replay and revision inspector (`src/core/replay.ts`), 13-step golden-path director, JSON export bundle | 16 new replay tests, 9 new export tests, rewritten 13-step integration test; `npm run verify` exit 0 (316 tests) | _pending_ | _pending_ |
